...
/*-------------------------------------*/
    ...
    public class REALPRMS
    {
        ...
        public class ALM_HIS5_data
        {
            ...
            public int[] g_modal;        /* G code Modal */
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)]
            public byte[] g_dp;           /* #7:1 Block  #6�`#0 dp */
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)]
            public int[] a_modal;        /* B,D,E,F,H,M,N,O,S,T code Modal */
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)]
            public byte[] a_dp;           /* #7:1 Block  #6�`#0 dp */
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
            public int[] abs_pos;        /* Abs pos */
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
    ...
    public static extern short cnc_upload3( ushort FlibHndl, ref int a, [Out,MarshalAs(UnmanagedType.LPStruct)] ODBUP3 b );
    ...
    /* cnc_rdopmsg3:read operator's message */
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi, Pack = 4)]
    public class OPRdExecProg_data
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 256)]
